# ============================================================
# Evaluate Saved CNN + BiLSTM Electricity Usage Prediction Model
# ============================================================
...
if not os.path.exists(scaler_X_path) or not os.path.exists(scaler_y_path):
    raise FileNotFoundError("❌ Scalers not found. Please train and save CNN + BiLSTM model first.")
if not os.path.exists(data_path):
    raise FileNotFoundError(f"❌ Dataset not found at: {data_path}")

print("✅ Loading saved CNN + BiLSTM model and scalers...")
...
print("🔍 Evaluating saved CNN + BiLSTM model (no training)...")
...
print("\n📊 Saved CNN + BiLSTM Model Performance Metrics:")
print("---------------------------------------------------")
...
plt.title("Predicted vs Actual Energy (Saved CNN + BiLSTM)")
...
metrics_file = os.path.join(base_path, "cnn_bilstm_saved_model_performance.csv")
...
print("\n✅ Evaluation Complete — Saved CNN + BiLSTM Model Performance Summary:")
print(f"📊 R² Score: {r2:.4f}")
